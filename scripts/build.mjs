...
for (const name of ['MATHEMATICS.md', 'ACCESSIBILITY.md', 'FIELD-MATHEMATICS.md', 'FIELD-GUIDE.md', 'RELATIONS-MATHEMATICS.md', 'RELATIONS-GUIDE.md', 'COMPLETENESS-MATHEMATICS.md', 'COMPLETENESS-GUIDE.md', 'TAYLOR-MATHEMATICS.md', 'TAYLOR-GUIDE.md', 'SERIES-MATHEMATICS.md', 'SERIES-GUIDE.md']) {
...
await writeFile(resolve(out, 'relations-lab.html'), standalone.replace('<body>', '<body data-initial-lab="differentiability&mode=relations">'));
await writeFile(resolve(out, 'completeness-lab.html'), standalone.replace('<body>', '<body data-initial-lab="completeness">'));
