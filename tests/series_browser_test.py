...
try:
 with sync_playwright() as p:
  ...
  expect(page.locator('#se-title')).to_have_text('不是谁更强，而是谁够用。');expect(page.locator('#nav-series')).to_have_attribute('aria-current','page');assert page.locator('.lab-nav').count()==9
