...
try:
 with sync_playwright() as p:
  ...
  expect(page.locator('#ty-title')).to_have_text('从一个点，长出一条曲线。');expect(page.locator('#nav-taylor')).to_have_attribute('aria-current','page');assert page.locator('.lab-nav').count()==9;assert progress(page)==0
